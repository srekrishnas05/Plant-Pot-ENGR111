Hi there, here's the code for our system. We wrote this in Arduino.IDE and used an Arduino board for this. Note: this code isn't usable in its current form as I've had to omit network related info.
